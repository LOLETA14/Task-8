export default function Cards() {
    let card =[
        ...
        {h2:"Business",pargraph:"for Team that need sharingand reporting.",h22:"$8/mo",par:"5% discount durin 2022",li:[`Disk Space:5000 M.B`,`Bandwidth:5 TERA`,`SubDomains: Unlimited`,`Parked Domains: Unlimited`,`E-mail Accounts: Unlimited`,`Cpanel (control panel): Yes`,`Money Back Guarantee: 14 Days`],button:`3 Gifts per/mo for year`},
        {h2:"Enterprise",pargraph:"for large companies that needadmins & security",h22:"$12/mo",par:"8% discount durin 2022",li:[`Disk Space:10000 M.B`,`Bandwidth: 10 TERA`,`SubDomains: Unlimited`,`Parked Domains: Unlimited`,`E-mail Accounts: Unlimited`,`Cpanel (control panel): Yes`,`Money Back Guarantee: 14 Days`],button:`Just Call Us`}
    ]
 return(
        <>
